...
文件头一共 72 字节，文件头的长度 + 文件头中解析得到的文件长度，就可以得到一个用于标识模型信息的 json 字符串。
...
# 3. 打印模型信息
-> % dd if=assets/yolov5s-640-640.rknn bs=1 skip=$((8355648+72)) count=$((8357380-8355648-72)) status=none | jq
{
  "connection": [
    {
      "left": "input",
